...
function initGenerateObject(Jolt, physicsSystem, scene) {
// Graphics variables
...
// Remove older dynamic cubes if the total gets too large
if (dynamicObjects.length > 200) {
	removeFromScene(dynamicObjects[1]); // Keep index 0 if it's your floor
}
}
...
// 	renderer,
// 	controls,
// 	// Add other objects you need to access externally
// };
}

export default initGenerateObject;
